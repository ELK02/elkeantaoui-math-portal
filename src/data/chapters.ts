    ...
    semesters: [
      {
        ...
        label: "Semestre 1",
        chapters: [
          { slug: "nombres-rationnels-introduction-ordre", title: "Les nombres rationnels — Introduction et ordre", order: 1, href: lesson("2ac", "s1", "nombres-rationnels-introduction-ordre") },
          { slug: "addition-soustraction-nombres-rationnels", title: "Addition et soustraction des nombres rationnels", order: 2, href: lesson("2ac", "s1", "addition-soustraction-nombres-rationnels") },
          { slug: "produit-division-nombres-rationnels", title: "Produit et division des nombres rationnels", order: 3, href: lesson("2ac", "s1", "produit-division-nombres-rationnels") },
          { slug: "puissance", title: "Puissance", order: 4, href: lesson("2ac", "s1", "puissance") },
          { slug: "symetrie-axiale", title: "Symétrie axiale", order: 5, href: lesson("2ac", "s1", "symetrie-axiale") },
          { slug: "droites-remarquables-triangle", title: "Les droites remarquables dans un triangle", order: 6, href: lesson("2ac", "s1", "droites-remarquables-triangle") },
          { slug: "droites-des-milieux-triangle", title: "Droites des milieux dans un triangle", order: 7, href: lesson("2ac", "s1", "droites-des-milieux-triangle") },
        ],
      },
      {
        id: "s2",
