...
export function HeroIllustration() {
  return (
    <div className="relative mx-auto hidden aspect-square w-full max-w-md lg:block">
      ...
      {/* Main notebook card */}
      <div className="absolute inset-x-4 top-6 bottom-16 rotate-[-2deg] rounded-xl border border-white/15 bg-white/[0.06] p-6 shadow-2xl backdrop-blur-sm">
        <div
        ...
        <div className="relative flex h-full flex-col">
          <span className="w-fit rounded border border-orange-500/30 bg-orange-500/10 px-2.5 py-1 font-mono text-[11px] font-medium uppercase tracking-wider text-orange-300">
      ...
      <div className="absolute -left-2 bottom-16 flex items-center gap-2 rounded-lg border border-black/5 bg-white px-4 py-3 shadow-xl sm:-left-6">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-green-100 text-green-700">
          <Check className="h-4 w-4" strokeWidth={3} />
        </span>
        <div className="leading-tight">
          <p className="text-xs font-semibold text-navy-900">Exercice corrigé</p>
          <p className="text-[11px] text-foreground-muted">Étape par étape</p>
        </div>
      </div>

      {/* Floating pi badge */}
      <div className="absolute -right-2 top-2 flex h-16 w-16 rotate-3 items-center justify-center rounded-lg bg-orange-500 shadow-xl sm:right-2">
